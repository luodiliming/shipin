...
@section('content')
    ...
    <form action="/admin/lesson" method="post" role="form" class="form-horizontal">
        {{csrf_field()}}
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea name="introduce" rows="5" class="form-control" style="resize: none"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        @foreach($data as $v)
                            <label class="checkbox-inline">
                                <input type="checkbox" name="tag_ids[]" value="{{$v['id']}}"> {{$v['name']}}
                            </label>
                        @endforeach
                    </div>
                </div>
