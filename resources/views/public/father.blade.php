...
<head>
    ...
    <script>
        ...
        hdjs = {
            ...
            'uploader': '/component/upload',//先找路由！
            'filesLists': '/component/filesLists?',//这个也是路由找到路由 才能找到控制里面方法！
            'removeImage': '?s=component/upload/removeImage&m=member&siteid=18',
//            'ossSign': '?s=component/oss/sign&m=member&siteid=18',//上传视屏路由！
        };
    </script>
        ...
        function loginout() {
            require(['util'],function (util) {
                util.confirm('确定退出登录吗?',function(){
                    location.href = '/admin/loginout';//会弹出是否要退出  给个路由！
                })
            })
        }
    </script>
